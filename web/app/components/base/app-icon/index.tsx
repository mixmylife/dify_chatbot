...
//   const Icon = (icon && icon !== '') ? <em-emoji id={icon} /> : <img src="/logo/chatbot-ai-100.png" className="h-full w-full rounded-full object-cover" />
//   //1  <img src="/logo/chatbot-ai-100.png" className="h-full w-full rounded-full object-cover" /> : <img src="/logo/chatbot-ai-100.png" className="h-full w-full rounded-full object-cover" />
//   //2  <em-emoji id='🤖' />
...
const AppIcon: FC<AppIconProps> = ({
  ...
  return (
    ...
    >
      <img
        src="/logo/chatbot-ai-100.png"
        alt="app icon"
        className="h-full w-full object-cover rounded-full"
      />
      {showEditIcon && isHovering && (
        <div className="absolute left-0 top-0 z-10 flex items-center justify-center bg-black/40 w-full h-full rounded-full">
          <RiEditLine className="text-white size-4" />
        </div>
      )}
      {coverElement}
    </span>
