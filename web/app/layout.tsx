  ...
  return (
    <html lang={locale ?? 'en'} className={cn('h-full', instrumentSerif.variable)} suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Meditech AI ChatBot" />
        <link rel="apple-touch-icon" href="/faviconn.ico" />
        <link rel="icon" type="image/x-icon" sizes="32x32" href="/faviconn.ico" />
        <link rel="icon" type="image/x-icon" sizes="16x16" href="/faviconn.ico" />
